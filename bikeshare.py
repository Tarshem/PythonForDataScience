...
def get_filters():
    ...
    while True:
        city = str(input(
            "Enter a city which you want to explore bikeshare data (chicago,new york city,washington)\n").strip().lower())
    ...
    while True:
        month = str(input(
            "Enter a month which you want to explore bikeshare data ( january, february, ... , june)\n").strip().lower())
    ...
    while True:
        day = str(input(
            "Enter a day which you want to explore bikeshare data (sunday,monday,.....,saturday)\n").strip().lower())
